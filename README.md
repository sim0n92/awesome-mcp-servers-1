...
- [ui-ticket-mcp](https://github.com/0ics-srls/ui-ticket-mcp_public) - Human-to-AI code review bridge. Annotate UI elements in the browser with review comments, and AI agents read the feedback via MCP to fix code automatically — with full element context (CSS selector, styles, DOM path, accessibility info). Install: `uvx ui-ticket-mcp`
